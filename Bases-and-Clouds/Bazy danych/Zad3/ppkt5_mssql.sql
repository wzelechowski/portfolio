...
from sys.dm_tran_locks
where request_session_id = @@spid
--5. W ramach sesji nr 1 podwy¿sz o 100 z³ pensjê wszystkich pracowników.
update employees set salary = salary + 100;

--6. W ramach sesji nr 2 rozpocznij transakcjê.
begin transaction;
--7. W ramach sesji nr 2 wyœwietl wszystkich pracowników.
select * from employees;

--8. W ramach sesji nr 1 wycofaj transakcjê.
...
--10. W ramach sesji nr 2 zatwierdŸ transakcjê.
commit transaction;

--11. W którym momencie uda³o Ci siê wyœwietliæ wszystkich pracowników w ramach sesji nr 2?
