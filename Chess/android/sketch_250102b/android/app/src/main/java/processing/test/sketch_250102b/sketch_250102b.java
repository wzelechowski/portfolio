...
/* autogenerated by Processing revision 1295 on 2025-01-29 */
...
public class sketch_250102b extends PApplet {
...
public void createPieces(ArrayList<Piece> pieces) {
...
public void promoteTo(Piece newPiece) {
...
public King getKing(boolean isWhiteTurn) {
  for (Piece piece : pieces) {
...
public boolean canMoveOutOfCheck(King king) {
  for (Piece piece : pieces) {
    if (piece.isWhite() == king.isWhite()) {
      for (int targetX = 0; targetX < 8; targetX++) {
        for (int targetY = 0; targetY < 8; targetY++) {
...
class Pole {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_250102b" };
    if (passedArgs != null) {
