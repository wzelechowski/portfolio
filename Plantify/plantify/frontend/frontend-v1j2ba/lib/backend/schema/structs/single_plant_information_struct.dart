...
class SinglePlantInformationStruct extends BaseStruct {
  SinglePlantInformationStruct({
    ...
    RecognizeResponseStruct? pruningCount,
    String? seeds,
  ...
  // "pruningCount" field.
  RecognizeResponseStruct? _pruningCount;
  RecognizeResponseStruct get pruningCount =>
      _pruningCount ?? RecognizeResponseStruct();
  set pruningCount(RecognizeResponseStruct? val) => _pruningCount = val;

  void updatePruningCount(Function(RecognizeResponseStruct) updateFn) {
    updateFn(_pruningCount ??= RecognizeResponseStruct());
  }
  ...
  static SinglePlantInformationStruct fromMap(Map<String, dynamic> data) =>
      SinglePlantInformationStruct(
        ...
        pruningCount: data['pruningCount'] is RecognizeResponseStruct
            ? data['pruningCount']
            : RecognizeResponseStruct.maybeFromMap(data['pruningCount']),
  ...
  static SinglePlantInformationStruct fromSerializableMap(
      ...
      SinglePlantInformationStruct(
        ...
        pruningCount: deserializeStructParam(
          ...
          ParamType.DataStruct,
          false,
          structBuilder: RecognizeResponseStruct.fromSerializableMap,
        ),
...
SinglePlantInformationStruct createSinglePlantInformationStruct({
  ...
  String? originalUrl,
    ...
    SinglePlantInformationStruct(
      ...
      watering: watering,
      wateringGeneralBenchmark:
          wateringGeneralBenchmark ?? WateringBenchmarkStruct(),
      pruningCount: pruningCount ?? RecognizeResponseStruct(),
      seeds: seeds,
      flowers: flowers,
