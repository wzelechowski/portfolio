      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CreatePlantWidget(
            ...
            recognizeSpecies: params.getParam(
              'recognizeSpecies',
              ParamType.String,
            ),
            uploadedImage: params.getParam(
              'uploadedImage',
              ParamType.FFUploadedFile,
            ),
            nbresults: params.getParam(
              'nbresults',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => SinglePlantGuidePageWidget(
            ...
            plant: params.getParam(
              ...
              isList: false,
              structBuilder: SinglePlantInformationStruct.fromSerializableMap,
            ),
          ),
        ),
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ShoppingList')
              : ShoppingListWidget(),
        ),
        FFRoute(
          name: ItemListWidget.routeName,
          path: ItemListWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ItemListWidget(
            listRow: params.getParam<ShoppingListsRow>(
              'listRow',
        ...
        FFRoute(
          name: ChangeCalendarWidget.routeName,
          path: ChangeCalendarWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ChangeCalendarWidget(
            plant: params.getParam<PlantsRow>(
              'plant',
              ParamType.SupabaseRow,
            ),
