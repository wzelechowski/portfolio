    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case PlantCategoriesRow:
            return PlantCategoriesRow(data);
          case PlantsRow:
            return PlantsRow(data);
          case PlantsProfilesRow:
            return PlantsProfilesRow(data);
          case ListItemsRow:
            return ListItemsRow(data);
          case EventsRow:
            return EventsRow(data);
          case EventsScheduleModesRow:
            return EventsScheduleModesRow(data);
          case ShoppingListsRow:
            return ShoppingListsRow(data);
