...
class AddCalendarWidget extends StatefulWidget {
  ...
  static String routeName = 'AddCalendar';
  static String routePath = '/addCalendar';
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if ((_model.choiceChipsValue ==
                                            'Periodic') ||
                                        (_model.choiceChipsValue == 'Okresowe'))
                                      FutureBuilder<
                                          List<EventsScheduleModesRow>>(
                                        future: EventsScheduleModesTable()
                                            .queryRows(
                                          queryFn: (q) =>
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<EventsScheduleModesRow>
                                              dropDownEventsScheduleModesRowList =
                                              snapshot.data!;
                                          ...
                                          return FlutterFlowDropDown<String>(
                                            ...
                                            options: List<String>.from(
                                                dropDownEventsScheduleModesRowList
                                                    ...
                                                    .withoutNulls
                                                    .toList()),
                                            optionLabels: FFLocalizations.of(
                                                            context)
                                                        .languageCode ==
                                                    'pl'
                                                ? dropDownEventsScheduleModesRowList
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if ((_model.choiceChipsValue == 'Periodic') ||
                                      (_model.choiceChipsValue == 'Okresowe')) {
                                    _model.mode =
                                        await EventsScheduleModesTable()
                                            .queryRows(
                                    ...
                                    await EventsTable().insert({
                                      ...
                                      'event_date': supaSerialize<DateTime>(
                                          _model.calendarSelectedDay?.start),
                                      'schedule_mode':
                                          _model.mode?.firstOrNull?.id,
                                      'is_scheduled': true,
                                    });
                                  } else {
                                    _model.eve = await EventsTable().insert({
                                      'event_name': _model.textController1.text,
                                      'plant_id': widget!.plant?.id,
                                      'user_id': currentUserUid,
                                      'done': false,
